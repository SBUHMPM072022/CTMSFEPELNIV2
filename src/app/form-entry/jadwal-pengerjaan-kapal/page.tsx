...
const mockData: QualityRow[] = [
  ...
  //   id: "160004",
  //   lokasi: "JAKARTA",
  //   namaKapal: "KM GUNUNG DEMPO",
  //   workDate: "2026-01-03",
  //   dateOfAnalysis: "2026-01-03",
...
export default function FormJadwalPengerjaanKapalPage() {
  ...
  return (
    <div className="flex min-h-screen bg-[#f5f6fa] font-sans">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <Header title="Form Jadwal Pengerjaan Kapal" />
        ...
        <div className="p-4 sm:p-8 flex-1 overflow-x-hidden">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
            ...
            <button
              onClick={() => router.push("/admin/create-jadwal-pengerjaan-kapal")}

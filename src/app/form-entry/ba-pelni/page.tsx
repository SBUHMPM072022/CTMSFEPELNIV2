...
const mockData: QualityRow[] = [
  // { id: "170008", lokasi: "AMBON", namaKapal: "KM PANGRANGO", workDate: "2026-01-01", dateOfAnalysis: "2026-01-01", createdDate: "2026-01-02", updatedUser: "" },
  // { id: "170007", lokasi: "AMBON", namaKapal: "KM SANGIANG", workDate: "2026-01-02", dateOfAnalysis: "2026-01-02", createdDate: "2026-01-03", updatedUser: "" },
  // { id: "170006", lokasi: "BALIKPAPAN", namaKapal: "KM LAMBELU", workDate: "2026-01-11", dateOfAnalysis: "2026-01-11", createdDate: "2026-01-12", updatedUser: "" },
  // { id: "170005", lokasi: "BALIKPAPAN", namaKapal: "KM BUKIT SIGUNTANG", workDate: "2026-01-12", dateOfAnalysis: "2026-01-12", createdDate: "2026-01-13", updatedUser: "" },
  // { id: "170004", lokasi: "JAKARTA", namaKapal: "KM TIDAR", workDate: "2026-01-02", dateOfAnalysis: "2026-01-02", createdDate: "2026-01-03", updatedUser: "" },
  // { id: "170003", lokasi: "JAKARTA", namaKapal: "KM GUNUNG DEMPO", workDate: "2026-01-03", dateOfAnalysis: "2026-01-03", createdDate: "2026-01-04", updatedUser: "" },
  // { id: "170002", lokasi: "SURABAYA", namaKapal: "KM SINABUNG", workDate: "2026-01-05", dateOfAnalysis: "2026-01-05", createdDate: "2026-01-06", updatedUser: "" },
  // { id: "170001", lokasi: "MAKASSAR", namaKapal: "KM BINAIYA", workDate: "2026-01-06", dateOfAnalysis: "2026-01-06", createdDate: "2026-01-07", updatedUser: "" },
];

export default function FormEntryBAPelniPage() {
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="p-8 flex-1 overflow-x-hidden">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
            ...
            <button
              onClick={() => router.push("/admin/create-bapelni")}

...
const defaultTimingRows: TimingRow[] = [
  { no: 1, activities: "NOR Tendered", time: "", date: "", remarks: "" },
  { no: 2, activities: "Barge Alongside", time: "", date: "", remarks: "" },
  { no: 3, activities: "Surveyor On Board", time: "", date: "", remarks: "" },
  { no: 4, activities: "Key Meeting", time: "", date: "", remarks: "" },
  { no: 5, activities: "NOR Accepted", time: "", date: "", remarks: "" },
  {
    no: 6,
    activities: "Tank Inspection Barge",
    time: "",
    date: "",
    remarks: "",
  },
  {
    no: 7,
    activities: "Tank Inspection Ship",
    time: "",
    date: "",
    remarks: "",
  },
  ...
  {
    no: 16,
    activities: "Surveyor Leave Vessel",
    time: "",
    date: "",
    remarks: "",
  },
...
/* ──────────────── component ──────────────── */
export default function DischargeCreatePage() {
  ...
  const r1Val = bargeAfterNum - bunkerOrderNum;
  const r1Pct = bunkerOrderNum !== 0 ? (r1Val / bunkerOrderNum) * 100 : 0;
  const r2Val = bargeBeforeNum - bargeAfterNum;
  const r2Pct = bunkerOrderNum !== 0 ? (r2Val / bunkerOrderNum) * 100 : 0;
  const r3Val = shipReceivedNum - bargeBeforeNum;
  const r3Pct = bunkerOrderNum !== 0 ? (r3Val / bunkerOrderNum) * 100 : 0;
  const r4Val = shipReceivedNum - bunkerOrderNum;
  const r4Pct = bunkerOrderNum !== 0 ? (r4Val / bunkerOrderNum) * 100 : 0;
        ...
        <div className="p-3 md:p-5 flex-1 overflow-x-hidden space-y-0">
            ...
            <Row label="Tanggal Kegiatan*" bg="bg-blue-50/50">
              <div className="flex-1">
                <input
                  ...
                  onBlur={formik.handleBlur}
                  type="date"
                  className={`w-[160px] px-3 py-[6px] border border-gray-300 rounded text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 bg-white text-gray-700 ${formik.touched.tanggalKegiatan && formik.errors.tanggalKegiatan ? "border-red-500" : ""}`}
                />
                        ...
                        <div key={idx} className="space-y-1">
                          <div className="flex items-center gap-2">
                            <select
                              ...
                              onChange={formik.handleChange}
                              onBlur={formik.handleBlur}
                              className={`${selectCls} w-full md:w-[200px] ${formik.touched.surveyors?.[idx]?.level && (formik.errors.surveyors as Record<string, string>[])?.[idx]?.level ? "border-red-500" : ""}`}
                            >
          ...
          <div className={`${sectionBodyCls} space-y-2`}>
            ...
            <div className="flex flex-col md:flex-row md:items-center bg-blue-50/50 p-2 rounded">
              ...
              <input
                name="meterQuantity"
                value={formik.values.meterQuantity}
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
                className={inputCls}
                style={{ maxWidth: 200 }}
            ...
            <div className="flex items-center mt-4">
              ...
              <div className="w-[150px] text-[12px] font-semibold text-gray-600">
                Flow Meter
              </div>
            </div>
            <div className="flex flex-col md:flex-row md:items-center bg-blue-50/50 p-2 rounded">
          ...
          <div className={sectionBodyCls}>
              ...
              {Object.entries(formik.values.remarkChecks).map(([key, val]) => (
                ...
                >
                  <input
                    ...
                    checked={val}
                    onChange={(e) => {
                      formik.setFieldValue(`remarkChecks.${key}`, e.target.checked);
                    }}
            ...
            {/* Ships & Sea Condition */}
            <div className="bg-blue-50/30 border border-gray-100 rounded-md p-5 mb-6">
              <h4 className="text-[13px] font-bold text-gray-700 mb-4">
                Ships &amp; Sea Condition
              </h4>
              <div className="grid grid-cols-2 gap-x-10">
                {/* On Arrival */}
                <div className="space-y-3">
                  <span className="text-[12px] font-bold text-gray-500 block">
                    On Arrival
                  </span>
                  <div className="space-y-2">
                    <Row label="Draft FWD/meter">
                      <input
